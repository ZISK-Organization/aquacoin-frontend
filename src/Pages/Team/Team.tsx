      ...
      {team.paid ? (
        ...
        <>
          ...
          <div style={styles.textContainer}>
            <div>
              Aby byla registrace týmu platná, musí být plně uhrazena cena <b>1 500 Kč</b> za tým. Cenu prosím uhraďte převodem na účet <b>115-2818930297/0100</b> a do zprávy pro příjemce uveďte <b>AQUACOIN-{team.name}</b> a jako variabilní symbol uveďte{" "}
              číslo <b>{team.id}</b>. Případne zaplaťte pomocí následující QR platby
            </div>
