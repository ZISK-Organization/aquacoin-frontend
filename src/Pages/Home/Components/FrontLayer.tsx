      ...
      <div style={{ ...styles.root, minHeight: "calc(100vh - 64px)" }}>
        <div style={styles.container}>
          ...
          <div style={styles.column}>
            ...
            <div style={styles.text}>
              AQUACoin je denní, lineární šifrovací hra, která se celá odehrává na vodní ploše a všechny přesuny jsou tak uskutečněny výhradně na lodích. Každý tým dostane zapůjčenou loď spolu s první šifrou, která prozradí lokaci šifry následující, až se
